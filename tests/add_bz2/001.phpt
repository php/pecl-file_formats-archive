...
$file = dirname(__FILE__)."/tmp.tar.bz2";

$writer = new ArchiveWriter($file, 0, ARCH_COMPRESSION_BZIP2);
...
bool(true)
bool(false)
string(%d) "%sadd_bz2/../_files/bsdtar.cpio"
bool(false)
int(1297)
object(ArchiveEntry)#%d (1) {
  ["entry"]=>
...
bool(true)
bool(false)
string(%d) "%sadd_bz2/../_files/bsdtar.cpio.gz"
bool(false)
int(463)
Done
